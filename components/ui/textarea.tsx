  ...
  return (
    <span
      ...
      className={clsx([
        ...
        // Focus ring
        "after:pointer-events-none after:absolute after:inset-0 after:rounded-xl after:ring-inset after:ring-transparent sm:after:focus-within:ring-2 sm:after:focus-within:ring-blue-500",
