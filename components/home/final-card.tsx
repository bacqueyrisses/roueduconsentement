...
export function FinalCard({ score }: { score: User["score"] }) {
  return (
    <motion.div
      className="absolute flex h-60 w-96 animate-fade-up flex-col justify-between rounded-3xl border border-neutral-200 bg-white p-4 opacity-0 shadow-xl shadow-black/[0.1] md:h-[20rem] md:w-[32rem] md:p-5"
    ...
    >
      ...
      >
        <p>
          ...
          <Highlight score={score}>{score?.toFixed(1)} sur 10.</Highlight>{" "}
          <br />
